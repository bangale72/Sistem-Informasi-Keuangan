...
<head>
  ...
  <meta name="description" content="Sistem Informasi Keuangan Berbasis Web">
            ...
            <!-- Nested Row within Card Body -->
                ...
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h2 class="h4 text-gray-800 mb-3">Selamat Datang</h2>
                  </div>
                  ...
                  <hr>
                  <p class="text-center">Hak Cipta &copy; 2024 Farhan Maulana Syidiq</p>
                </div>
